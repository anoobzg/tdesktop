...
list(APPEND TELEGRAM_QT_LIBS Core CorePrivate Gui GuiPrivate Widgets WidgetsPrivate Network Svg Quick QuickWidgets)

if (QT_VERSION_MAJOR GREATER_EQUAL 6)
    find_package(Qt${QT_VERSION_MAJOR} COMPONENTS OpenGL OpenGLWidgets REQUIRED)
    list(APPEND TELEGRAM_QT_LIBS OpenGL OpenGLWidgets)
endif()

if (LINUX)
    find_package(Qt${QT_VERSION_MAJOR} OPTIONAL_COMPONENTS DBus WaylandCompositor QUIET)
    list(APPEND TELEGRAM_QT_LIBS DBus WaylandCompositor)
endif()

# foreach(lib ${TELEGRAM_QT_LIBS})
# if(NOT TARGET Qt::${lib})
#     add_library(Qt::${lib} ALIAS Qt${QT_VERSION_MAJOR}::${lib})
# endif()
# endforeach()
